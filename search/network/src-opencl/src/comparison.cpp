...
struct signal
{
    ...
    template <> static bool compare<member::frequency>(const signal& lhs, const signal& rhs) { return lhs.frequency < rhs.frequency; }
    template <> static bool compare<member::spindown>(const signal& lhs, const signal& rhs) { return lhs.spindown < rhs.spindown; }
    template <> static bool compare<member::declination>(const signal& lhs, const signal& rhs) { return lhs.declination < rhs.declination; }
    template <> static bool compare<member::ascension>(const signal& lhs, const signal& rhs) { return lhs.ascension < rhs.ascension; }
    template <> static bool compare<member::signal_to_noise>(const signal& lhs, const signal& rhs) { return lhs.signal_to_noise < rhs.signal_to_noise; }
};
